	...
	attributes: {
		...
		graph: {
			...
			default: [{
				...
				cols: [{ classes: 'col color1', label: 'Áî∑' }, { classes: 'col color2', label: 'Â•≥' }]
			}]
		}
	},
	edit: function edit(_ref) {
		...
		var selectiveClasses = [{
			...
			values: {
				BarChart: 'Ê£í„Ç∞„É©„É?',
				PieChat: 'ÂÜ?Ç∞„É©„É?',
				LineChart: 'Êäò„ÇåÁ∑ö„Ç∞„É©„É?',
				RadarChart: '„É¨„Éº„É?„Éº„ÉÅ„É£„Éº„É?'
			}
		}];
