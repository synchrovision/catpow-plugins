registerBlockType('catpow/datatable', {
	...
	edit: function edit(_ref) {
		...
		var statesClasses = [{ label: '„Éò„ÉÉ„É?Ë°?', values: 'hasHeaderRow' }, { label: '„Éò„ÉÉ„É?Âà?', values: 'hasHeaderColumn' }];
		var selectiveClasses = [{ label: '„Çø„Ç§„É?', filter: 'type', values: ['spec', 'sheet', 'plan'] }, 'color'];
