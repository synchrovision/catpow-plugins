...
$conf=[
	...
	'meta'=>[
		'cp_amazonpay_keys'=>['type'=>'options','option'=>'cp_amazonpay_keys','meta'=>[
			...
			'access_key'=>['type'=>'text','label'=>'アクセスキーID','size'=>70],
			'secret_key'=>['type'=>'text','label'=>'シークレットアクセスキー','size'=>70],
			'client_id'=>['type'=>'text','label'=>'クライアントID','size'=>70],
			'client_secret'=>['type'=>'text','label'=>'クライアントシークレット','size'=>70],
